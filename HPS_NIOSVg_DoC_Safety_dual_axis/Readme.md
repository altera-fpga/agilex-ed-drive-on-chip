...
Drive-On-Chip (DoC) with Functional Safety with an HPS instance for speed monitoring.
...
To run example systems on hardware, the user may need the appropriate board the design is targeting and any relevant
accessories like daughter cards etc.
<br>
<br>
...
You can select any other available XML targeting other boards from the `HPS_NIOSVg_DoC_Safety_dual_axis` directory.
...
**Note:** The user must generate the RBF/JIC pair to boot and program this design example into a board
