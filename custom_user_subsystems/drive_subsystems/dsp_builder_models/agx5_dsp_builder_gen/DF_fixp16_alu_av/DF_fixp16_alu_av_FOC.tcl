# This is the top level tcl file for 'DF_fixp16_alu_av_FOC'
...
if {!$overwrite_opt && [project_exists DF_fixp16_alu_av_FOC]} {
    puts "The DF_fixp16_alu_av_FOC quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "./../../dsp_builder_gen/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC.tcl"]}    {
    puts "You must run DF_fixp16_alu_av_FOC.tcl "
...
puts "Creating DF_fixp16_alu_av_FOC Quartus project..."

if $overwrite_opt {
    project_new -overwrite DF_fixp16_alu_av_FOC
} else {
    project_new DF_fixp16_alu_av_FOC
}

set_global_assignment -name FAMILY "Agilex 5"
set_global_assignment -name TOP_LEVEL_ENTITY DF_fixp16_alu_av_FOC
set_global_assignment -name DEVICE SM7_FC1P0_PART2
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ./../../dsp_builder_gen/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
source ./../../dsp_builder_gen/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to Iu
set_instance_assignment -name VIRTUAL_PIN ON -to Iw
set_instance_assignment -name VIRTUAL_PIN ON -to vu_pwm
set_instance_assignment -name VIRTUAL_PIN ON -to vv_pwm
set_instance_assignment -name VIRTUAL_PIN ON -to vw_pwm
...
source "./../../dsp_builder_gen/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC_fpc.add.tcl"
