...
entity motor_kit_sim_20MHz_MotorModel_Current_scale_64_x_atb is
end;

architecture normal of motor_kit_sim_20MHz_MotorModel_Current_scale_64_x_atb is
...
component motor_kit_sim_20MHz_MotorModel_Current_scale_64_x_stm is
    port (
...
signal in_1_Current_range_int16_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_Current_sfix16_En10_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_1_Fraction_ND_ufix16_En16_x_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_1_Current_range_int16_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_Current_sfix16_En10_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
checkGPIn : process (clk, areset, in_1_Current_range_int16_tpl_dut, in_1_Current_range_int16_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkGPIn1 : process (clk, areset, in_2_Current_sfix16_En10_tpl_dut, in_2_Current_sfix16_En10_tpl_stm)
begin
END PROCESS;
...
dut : motor_kit_sim_20MHz_MotorModel_Current_scale_64_x port map (
    in_1_Current_range_int16_tpl_stm,
    in_2_Current_sfix16_En10_tpl_stm,
    out_1_Fraction_ND_ufix16_En16_x_tpl_dut,
        clk,
        areset
);

sim : motor_kit_sim_20MHz_MotorModel_Current_scale_64_x_stm port map (
    in_1_Current_range_int16_tpl_stm,
    in_2_Current_sfix16_En10_tpl_stm,
