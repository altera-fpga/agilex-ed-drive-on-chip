...
entity motor_kit_sim_20MHz_MotorModel_Voltage_scale_120_link_V_atb is
end;

architecture normal of motor_kit_sim_20MHz_MotorModel_Voltage_scale_120_link_V_atb is
...
component motor_kit_sim_20MHz_MotorModel_Voltage_scale_120_link_V_stm is
    port (
...
checkGPIn : process (clk, areset, in_2_Voltage_sfix16_En9_tpl_dut, in_2_Voltage_sfix16_En9_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkGPIn1 : process (clk, areset, in_1_Voltage_range_int16_tpl_dut, in_1_Voltage_range_int16_tpl_stm)
begin
END PROCESS;
...
dut : motor_kit_sim_20MHz_MotorModel_Voltage_scale_120_link_V port map (
...
sim : motor_kit_sim_20MHz_MotorModel_Voltage_scale_120_link_V_stm port map (
    in_2_Voltage_sfix16_En9_tpl_stm,
    in_1_Voltage_range_int16_tpl_stm,
