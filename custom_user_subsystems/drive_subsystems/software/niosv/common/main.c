...
extern void motion_task_tmr_cb(void *ptmr, void *parg); //!< Function implement motion task (waveform generation)
extern void motion_task_init(void);
...
void drive_enable_callback(void)
{
    ...
    // start motion thread timer
    OSTmrStart(motion_timer, &err);
...
void drive_reset_callback(void)
{
    ...
    // stop motion thread timer
    OSTmrStop(motion_timer, OS_TMR_OPT_NONE, NULL, &err);
...
int main(void)
{
    ...
    motion_timer = OSTmrCreate(MOTION_TMR_PERIOD,
                               MOTION_TMR_PERIOD,
                               OS_TMR_OPT_PERIODIC,
                               motion_task_tmr_cb,
                               NULL,
